...
ui <- fluidPage(
  ...
  # Section 1: Initialization of NUM_TRIALS, NUM_ARMS, and SEED
  fluidRow(
  ...
  # Section 2: Reward Matrix Visualization
  fluidRow(
    column(12, 
           h3("Reward Matrix Demo"),
           plotOutput("reward_matrix", height = "300px")
    )
  ),
  
  # Section 3: State and Arm Variables Configuration (side by side)
  fluidRow(
    ...
    column(6,
           ...
           fluidRow(
             ...
             column(3, selectInput("state_pattern", "Allocation", choices = c("Loop", "Random"))),
    ...
    column(6,
           ...
           fluidRow(
             ...
             column(3, selectInput("arm_pattern", "Allocation", choices = c("Loop", "Random"))),
             column(3, div(style = "margin-top: 25px;",
  ...
  # Section 4: Reward Distribution Configuration
  fluidRow(
    column(12,
